 ...
 /* std::vector<std::pair<double, double>>
  ...
  /*std::vector<std::pair<double, double>>
	  vec{ {1, 10}, {2, 9}, {3, 8},
		  ...
		  {7, 4}, {8, 3} };*/
  /*std::vector<std::pair<double, double>>
	  vec{ {1, 10}, {3, 6}, {3, 7}, {3, 7},
	   {3, 9}, {5, 6}, {6, 5},
	   {7, 4}, {8, 1} };*/
  std::vector<std::pair<double, double>>
	  vec{ {1, 10}, {3, 8}, {5, 5}, {7, 3},
		  {8, 2} };
  ...
  if( options_p->is_pareto() )
     std::cout << "PARETO! is_paret" << std::endl;
  ...
  //std::cout << "gonna go into insert pareto sorted" << std::endl;
  //if (options_p->insert_pareto_sorted(8, 1))
	 // std::cout << "INSERT_PARETO_SORTED WORKED!" << std::endl;
  //else
	 // std::cout << "INSERT_PARETO_SORTED FAILED!" << std::endl;

  //if (options_p->insert_pareto_sorted(5, 4))
	 // std::cout << "INSERT_PARETO_SORTED WORKED!" << std::endl;
  //else
	 // std::cout << "INSERT_PARETO_SORTED FAILED!" << std::endl;
  //options_p->display();
  //if (options_p->insert_pareto_sorted(8, 3))
	 // std::cout << "INSERT_PARETO_SORTED WORKED!" << std::endl;
  //else
	 // std::cout << "INSERT_PARETO_SORTED FAILED!" << std::endl;
