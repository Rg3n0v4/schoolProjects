...
class ThreeCardTest {
	...
	public void evalPP_straightHandTest()
	{
		...
		assertEquals(6, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()),"evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void evalPP_threeOfAKindHandTest()
	{
		...
		player.setPairPlayBet(1);
		assertEquals(30, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void evalPP_flushHandTest()
	{
		...
		player.setPairPlayBet(1);
		assertEquals(3, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void evalPP_straightFlushHandTest()
	{
		...
		player.setPairPlayBet(1);
		assertEquals(40, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void evalPP_pairHandTest()
	{
		...
		player.setPairPlayBet(1);
		assertEquals(1, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void n_evalPP_straightHandTest()
	{
		...
		player.setHand(straightHand);
		player.setPairPlayBet(1);
		assertNotEquals(631, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()),"evalPPWinnings calculation for pair are wrong");
	}
	@Test
	public void n_evalPP_threeOfAKindHandTest()
	{
		...
		player.setHand(threeHand);
		player.setPairPlayBet(1);
		assertNotEquals(320, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for three of a kind are wrong");
	}
	@Test
	public void n_evalPP_flushHandTest()
	{
		...
		player.setHand(flushHand);
		player.setPairPlayBet(1);
		assertNotEquals(321, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for flush are wrong");
	}
	@Test
	public void n_evalPP_straightFlushHandTest()
	{
		...
		player.setHand(straightFlushHand);
		player.setPairPlayBet(1);
		assertNotEquals(404, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for straight flush are wrong");
	}
	@Test
	public void n_evalPP_pairHandTest()
	{
		...
		player.setHand(pairHand);
		player.setPairPlayBet(1);
		assertNotEquals(456, ThreeCardLogic.evalPPWinnings(player.getHand(), player.getPairPlayBet()), "evalPPWinnings calculation for pair are wrong");
	}
}
