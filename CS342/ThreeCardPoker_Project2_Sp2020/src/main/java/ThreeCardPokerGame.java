	...
	//PLAYER 2 BUTTONS AND FUNCTIONALITY
		foldBtn2.setOnAction(e->{//player 2 decides to fold
			...
			else
			{
				...
				{
					int deciderOne = ThreeCardLogic.compareHands(dealer.dealersHand, playerOne.getHand());
					if (deciderOne == 0)
					{
						// no one wins
		...
		playBtn2.setOnAction(e->{ //player2 wants to play
			...
			else
			{
				...
				int deciderTwo = ThreeCardLogic.compareHands(dealer.dealersHand, playerTwo.getHand());
